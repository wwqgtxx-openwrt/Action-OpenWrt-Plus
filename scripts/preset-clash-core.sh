...
clash_main_url=https://github.com/wwqgtxx/clashr/releases/download/v1.4.2.2/clashr-linux-amd64-v1.4.2.2.gz
clash_tun_url=$(curl -sL https://api.github.com/repos/vernesong/OpenClash/releases/tags/TUN-Premium | grep /clash-linux-$1 | sed 's/.*url\": \"//g' | sed 's/\"//g')
clash_game_url=https://github.com/wwqgtxx/clashr/releases/download/v1.4.2.2-tun/clashr-linux-amd64-v1.4.2.2-tun.gz
